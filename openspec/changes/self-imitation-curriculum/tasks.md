...
- [x] 3.2 (RESOURCES done with the appendix params; NOTES sections and record 0015 written; outcome.md complete) RESOURCES: SIL appendix hyperparameters; NOTES sections (self-imitation, start-state curricula); learning record if demonstrated.

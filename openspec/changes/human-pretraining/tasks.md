...
- [x] 1.2 Build the December 2013 set (300k / 15k) and `midgame_starts.csv`.

## 2. Pretraining
- [x] 2.1 `scripts/pretrain_human.py` with held-out accuracy log and checkpoint; smoke test on the fixture.
- [x] 2.2 Run 3 epochs; evaluate the checkpoint on puzzles and 40 games.
...
- [x] 4.1 PPO 600 updates (owner: "there is a lot time avaible") `init_from` the SL checkpoint with 4 mid-game boards; 40 games; summary.
- [x] 4.2 Outcome in the proposal, notes, session, workshop section.

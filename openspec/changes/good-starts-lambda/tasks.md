...
- [ ] 2.1b Follow-ups (owner: "okay agreed on both"): arm LAMBDA (levels + lambda 1.0, queen-only, from CURSIL_LONG; isolates lambda) and arm GSL2 (good starts with warm start + lambda 1.0); outcome.

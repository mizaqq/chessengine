...
- [ ] 1.2 `prepare_puzzles.py --depth 2` with forced-mate verification; tests; build the files.
...
- [ ] 4.2 Outcome in the proposal; notes; session.

## 5. Comprehension check (in chat)
